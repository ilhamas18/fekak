...
import DataLaporanRenstra from '@/components/pages/laporan/renstra/list';

const LaporanRenstra = () => {
  const router = useRouter();
  const [dataRenstra, setDataRenstra] = useState<any>([]);
  ...
  return (
    <div className='container'>
      <Breadcrumb pageName="Laporan Rencana Strategis" />
      ...
      <div className="bg-white dark:bg-meta-4 dark:text-white shadow-card flex flex-col gap-2 py-6 text-center font-bold text-title-sm rounded rounded-lg border-none">
        <div>Laporan Rencana Strategis</div>
      </div>
      <div className='body relative'>
        ...
        <div style={gradientStyle}>
          <div className='px-4 flex text-white py-4 space-x-6 font-bold items-center'>
            ...
            <div className='text-title-xsm'>Laporan Rencana Strategis</div>
          </div>
        </div>
        <DataLaporanRenstra data={dataRenstra} />
      </div>
    </div>
  )
}

export default withAuth(LaporanRenstra);