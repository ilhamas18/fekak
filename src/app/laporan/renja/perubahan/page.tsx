...
import DataLaporanRankirPerubahan from '@/components/pages/laporan/renja/perubahan/list';

const LaporanPenetapan = () => {
  const router = useRouter();
  const [dataRenjaPerubahan, setDataRenjaPerubahan] = useState<any>([]);
  ...
  return (
    <div className='container'>
      <Breadcrumb pageName="Laporan Renja Perubahan" />
      ...
      <div className="bg-white dark:bg-meta-4 dark:text-white shadow-card flex flex-col gap-2 py-6 text-center font-bold text-title-sm rounded rounded-lg border-none">
        <div>Laporan Renja Perubahan</div>
      </div>
      <div className='body relative'>
        ...
        <div style={gradientStyle}>
          <div className='px-4 flex text-white py-4 space-x-6 font-bold items-center'>
            ...
            <div className='text-title-xsm'>Laporan Renja Perubahan</div>
          </div>
        </div>
        <DataLaporanRankirPerubahan data={dataRenjaPerubahan} />
      </div>
    </div>
  )
}
