...
import DataLaporanRankir2 from '@/components/pages/laporan/renja/rankir2/list';

const LaporanRankir2 = () => {
  const router = useRouter();
  const [dataRankir2, setDataRankir2] = useState<any>([]);
  ...
  return (
    <div className='container'>
      <Breadcrumb pageName="Laporan Rankir 2" />
      ...
      <div className="bg-white dark:bg-meta-4 dark:text-white shadow-card flex flex-col gap-2 py-6 text-center font-bold text-title-sm rounded rounded-lg border-none">
        <div>Laporan Rankir Renja 2</div>
      </div>
      <div className='body relative'>
        ...
        <div style={gradientStyle}>
          <div className='px-4 flex text-white py-4 space-x-6 font-bold items-center'>
            ...
            <div className='text-title-xsm'>Laporan Rankir Renja 2</div>
          </div>
        </div>
        <DataLaporanRankir2 data={dataRankir2} />
      </div>
    </div>
  )
}

export default withAuth(LaporanRankir2);