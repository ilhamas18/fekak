...
import DataLaporanRankir1 from '@/components/pages/laporan/renja/rankir1/list';

const LaporanRankir1 = () => {
  const router = useRouter();
  const [dataRankir1, setDataRankir1] = useState<any>([]);
  ...
  return (
    <div className='container'>
      <Breadcrumb pageName="Laporan Rankir 1" />
      ...
      <div className="bg-white dark:bg-meta-4 dark:text-white shadow-card flex flex-col gap-2 py-6 text-center font-bold text-title-sm rounded rounded-lg border-none">
        <div>Laporan Rankir Renja 1</div>
      </div>
      <div className='body relative'>
        ...
        <div style={gradientStyle}>
          <div className='px-4 flex text-white py-4 space-x-6 font-bold items-center'>
            ...
            <div className='text-title-xsm'>Laporan Rankir Renja 1</div>
          </div>
        </div>
        <DataLaporanRankir1 data={dataRankir1} />
      </div>
    </div>
  )
}

export default withAuth(LaporanRankir1);