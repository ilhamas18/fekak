...
import DataLaporanPenetapan from '@/components/pages/laporan/renja/penetapan/list';

const LaporanPenetapan = () => {
  const router = useRouter();
  const [dataPenetapan, setDataPenetapan] = useState<any>([]);
  ...
  return (
    <div className='container'>
      <Breadcrumb pageName="Laporan Penetapan" />
      ...
      <div className="bg-white dark:bg-meta-4 dark:text-white shadow-card flex flex-col gap-2 py-6 text-center font-bold text-title-sm rounded rounded-lg border-none">
        <div>Laporan Renja Penetapan</div>
      </div>
      <div className='body relative'>
        ...
        <div style={gradientStyle}>
          <div className='px-4 flex text-white py-4 space-x-6 font-bold items-center'>
            ...
            <div className='text-title-xsm'>Laporan Renja Penetapan</div>
          </div>
        </div>
        <DataLaporanPenetapan data={dataPenetapan} />
      </div>
    </div>
  )
}
