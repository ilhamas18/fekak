...
const DataLaporanRenstra = ({ data }: PropTypes) => {
              ...
              <Table stickyHeader aria-label="sticky table">
                <TableHead className='text-title-ss'>
                  <TableRow>
                    ...
                    <TableCell align="left" colSpan={28} sx={{ backgroundColor: '#ef4444', color: 'white' }}>NAMA BIDANG URUSAN</TableCell>
                  </TableRow>
                </TableHead>
                {data.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row1: any, index: number) => (
                  <>
                    <TableBody>
                      <TableRow hover role="checkbox" className='text-bold font-bold' tabIndex={-1} key={index}>
                        ...
                        <TableCell align='left' colSpan={28}>{row1.nama_bidang_urusan}</TableCell>
                      </TableRow>
                    </TableBody>
                    <TableHead className='text-title-ss'>
                      <TableRow>
                        ...
                        <TableCell style={{ borderBottom: "none", backgroundColor: '#06b6d4', color: 'white' }}></TableCell>
                        <TableCell style={{ borderBottom: "none", backgroundColor: '#06b6d4', color: 'white' }}></TableCell>
                        <TableCell colSpan={5} align="center" style={{ backgroundColor: '#06b6d4', color: 'white', border: '1px solid white' }}>2020</TableCell>
                        <TableCell colSpan={5} align="center" style={{ backgroundColor: '#06b6d4', color: 'white', border: '1px solid white' }}>2021</TableCell>
                        <TableCell colSpan={5} align="center" style={{ backgroundColor: '#06b6d4', color: 'white', border: '1px solid white' }}>2022</TableCell>
                        <TableCell colSpan={5} align="center" style={{ backgroundColor: '#06b6d4', color: 'white', border: '1px solid white' }}>2023</TableCell>
                        <TableCell colSpan={5} align="center" style={{ backgroundColor: '#06b6d4', color: 'white', border: '1px solid white' }}>2024</TableCell>
                      </TableRow>
                      <TableRow>
                      ...
                      <>
                        ...
                        <TableHead className='text-title-ss'>
                          <TableRow>
                            ...
                            <TableCell style={{ borderBottom: "none", backgroundColor: '#14b8a6', color: 'white' }}></TableCell>
                            <TableCell style={{ borderBottom: "none", backgroundColor: '#14b8a6', color: 'white' }}></TableCell>
                            <TableCell colSpan={5} align="center" style={{ backgroundColor: '#14b8a6', color: 'white', border: '1px solid white' }}>2020</TableCell>
                            <TableCell colSpan={5} align="center" style={{ backgroundColor: '#14b8a6', color: 'white', border: '1px solid white' }}>2021</TableCell>
                            <TableCell colSpan={5} align="center" style={{ backgroundColor: '#14b8a6', color: 'white', border: '1px solid white' }}>2022</TableCell>
                            <TableCell colSpan={5} align="center" style={{ backgroundColor: '#14b8a6', color: 'white', border: '1px solid white' }}>2023</TableCell>
                            <TableCell colSpan={5} align="center" style={{ backgroundColor: '#14b8a6', color: 'white', border: '1px solid white' }}>2024</TableCell>
                          </TableRow>
                          <TableRow>
                          ...
                          <>
                            ...
                            <TableHead className='text-title-ss'>
                              <TableRow>
                                ...
                                <TableCell style={{ borderBottom: "none", backgroundColor: '#93c5fd', color: 'white' }}></TableCell>
                                <TableCell style={{ borderBottom: "none", backgroundColor: '#93c5fd', color: 'white' }}></TableCell>
                                <TableCell colSpan={5} align="center" style={{ backgroundColor: '#93c5fd', color: 'white', border: '1px solid white' }}>2020</TableCell>
                                <TableCell colSpan={5} align="center" style={{ backgroundColor: '#93c5fd', color: 'white', border: '1px solid white' }}>2021</TableCell>
                                <TableCell colSpan={5} align="center" style={{ backgroundColor: '#93c5fd', color: 'white', border: '1px solid white' }}>2022</TableCell>
                                <TableCell colSpan={5} align="center" style={{ backgroundColor: '#93c5fd', color: 'white', border: '1px solid white' }}>2023</TableCell>
                                <TableCell colSpan={5} align="center" style={{ backgroundColor: '#93c5fd', color: 'white', border: '1px solid white' }}>2024</TableCell>
                              </TableRow>
                              <TableRow>
...
export default DataLaporanRenstra;