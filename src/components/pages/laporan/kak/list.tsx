...
const DataLaporanKAK = ({ data }: PropTypes) => {
          ...
          <Table stickyHeader aria-label="sticky table">
            <TableHead className='text-title-ss'>
              <TableRow>
                ...
                <TableCell align="center" style={{ minWidth: 220 }}>INDIKATOR</TableCell>
                <TableCell align="center" style={{ minWidth: 220 }}>TARGET</TableCell>
                <TableCell align="center" style={{ minWidth: 220 }}>SATUAN</TableCell>
                <TableCell align="center" style={{ minWidth: 220 }}>ANGGARAN</TableCell>
                  ...
                  return (
                    <React.Fragment>
                      <TableRow hover role="checkbox" className='bg-[#f1f5f9] text-bold font-bold' tabIndex={-1} key={index}>
                        ...
                        <TableCell align='center'>{row.anggaran}</TableCell>
                      ...
                      {row.pemilik_rencana.map((el: any, i: number) => (
                        <>
                          <TableRow hover role="checkbox" key={i}>
                            ...
                            <TableCell align='center'>{el.anggaran}</TableCell>
                            <TableCell align='center'>
                              <div className='flex flex-col gap-2'>
                          ...
                          {el.renaksi.map((el2: any, i2: number) => (
                            <TableRow hover role="checkbox" key={i2}>
                              ...
                              <TableCell align='center'>{el2.anggaran}</TableCell>
                              <TableCell></TableCell>
                            </TableRow>
                          ))}
                        </>
