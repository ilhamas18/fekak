...
const DataRekapStrategi = ({ data }: PropTypes) => {
          ...
          <Table stickyHeader aria-label="sticky table">
            <TableHead className='text-title-ss'>
              <TableRow>
                ...
                <TableCell align="center" style={{ minWidth: 220 }}>TIPE</TableCell>
                <TableCell align="center" style={{ minWidth: 140 }}>TAHUN SASARAN</TableCell>
                <TableCell align="center" style={{ minWidth: 140 }}>TAHUN STRATEGI</TableCell>
                <TableCell align="center" style={{ minWidth: 220 }}>ATASAN</TableCell>
                <TableCell align="center" style={{ minWidth: 220 }}>STRATEGI SASARAN</TableCell>
              </TableRow>
            </TableHead>
            {/* <TableBody>
              {data
...
export default DataRekapStrategi;