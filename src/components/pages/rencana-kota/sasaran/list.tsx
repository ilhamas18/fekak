...
const DataSasaranKota = ({ data }: PropTypes) => {
          ...
          <Table stickyHeader aria-label="sticky table">
            <TableHead>
              <TableRow>
                ...
                <TableCell align="center" style={{ minWidth: 220 }}>SASARAN KOTA</TableCell>
                <TableCell align="center" style={{ minWidth: 220 }}>PERIODE</TableCell>
                  ...
                  return (
                    <React.Fragment>
                      <TableRow hover role="checkbox" tabIndex={-1} key={index}>
                        ...
                        <TableCell align='center' rowSpan={row.indikator.length + 1}>{row.sasaran}</TableCell>
...
export default DataSasaranKota;