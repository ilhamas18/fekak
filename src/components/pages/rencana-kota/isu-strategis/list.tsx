...
const DataIsuStrategisKota = ({ data }: PropTypes) => {
                  ...
                  return (
                    <React.Fragment>
                      <TableRow hover role="checkbox" tabIndex={-1} key={index}>
                        <TableCell align='center' rowSpan={row.strategi.length + 1}>{index + 1}</TableCell>
                        <TableCell align='center' rowSpan={row.strategi.length + 1}>
                        ...
                        <TableCell align='center' rowSpan={row.strategi.length + 1}>{row.isu_strategis}</TableCell>
                        <TableCell align='center' rowSpan={row.strategi.length + 1}>{row.tahun}</TableCell>
                      </TableRow>
                      {row.strategi.map((el: any, i: number) => (
...
export default DataIsuStrategisKota;