...
const DataProgramKegiatan = ({ data, tahun }: PropTypes) => {
                  ...
                  <Table stickyHeader aria-label="sticky table">
                    <TableHead className='text-title-ss'>
                      <TableRow>
                        ...
                        <TableCell align="left" colSpan={52} sx={{ backgroundColor: '#ef4444', color: 'white' }}>NAMA BIDANG URUSAN</TableCell>
                      </TableRow>
                    </TableHead>
                    <TableBody>
                      <TableRow hover role="checkbox" className='text-bold font-bold' tabIndex={-1}>
                        ...
                        <TableCell align='left' colSpan={52}>{row1.nama_bidang_urusan}</TableCell>
                      </TableRow>
                    </TableBody>
                  </Table>
                      ...
                      <Table stickyHeader aria-label="sticky table">
                        <TableHead className='text-title-ss'>
                          <TableRow>
                            ...
                            <TableCell style={{ borderBottom: "none", backgroundColor: '#06b6d4', color: 'white' }}></TableCell>
                            <TableCell style={{ borderBottom: "none", backgroundColor: '#06b6d4', color: 'white' }}></TableCell>
                            <TableCell colSpan={5} align="center" style={{ backgroundColor: '#06b6d4', color: 'white', border: '1px solid white' }}>{tahun}</TableCell>
                          </TableRow>
                          <TableRow>
                            ...
                            <TableCell align="left" style={{ minWidth: 320, backgroundColor: '#06b6d4', color: 'white' }} rowSpan={2}>PROGRAM</TableCell>
                        ...
                        <>
                          <Table stickyHeader aria-label="sticky table">
                            <TableHead className='text-title-ss'>
                              <TableRow>
                                ...
                                <TableCell style={{ borderBottom: "none", backgroundColor: '#14b8a6', color: 'white' }}></TableCell>
                                <TableCell style={{ borderBottom: "none", backgroundColor: '#14b8a6', color: 'white' }}></TableCell>
                                <TableCell colSpan={5} align="center" style={{ backgroundColor: '#14b8a6', color: 'white', border: '1px solid white' }}>{tahun}</TableCell>
                              </TableRow>
                              <TableRow>
                                ...
                                <TableCell align="left" style={{ minWidth: 320, backgroundColor: '#14b8a6', color: 'white' }} rowSpan={2}>KEGIATAN</TableCell>
                          ...
                          <TableHead className='text-title-ss'>
                            <TableRow>
                              ...
                              <TableCell style={{ borderBottom: "none", backgroundColor: '#93c5fd', color: 'white' }}></TableCell>
                              <TableCell style={{ borderBottom: "none", backgroundColor: '#93c5fd', color: 'white' }}></TableCell>
                              <TableCell colSpan={5} align="center" style={{ backgroundColor: '#93c5fd', color: 'white', border: '1px solid white' }}>{tahun}</TableCell>
                            </TableRow>
                            <TableRow>
                              ...
                              <TableCell align="left" style={{ minWidth: 320, backgroundColor: '#93c5fd', color: 'white' }} rowSpan={2}>SUBKEGIATAN</TableCell>
                          ...
                          {row3.Sub_Kegiatans.map((row4: any, index4: number) => (
                            <>
                              {/* <Table stickyHeader aria-label="sticky table"> */}
